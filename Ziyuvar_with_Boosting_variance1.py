...
adaboost_model_train = AdaBoostClassifier(base_estimator=model_train_sklearn, n_estimators=1, learning_rate=1, algorithm='SAMME.R', random_state=seed)
...
adaboost_model_test= AdaBoostClassifier(base_estimator=model_test_sklearn, n_estimators=1, learning_rate=1, algorithm='SAMME.R', random_state=seed)

...
for train, test in kfold.split(X, Y):
	...
	train = train[0:int(Adapted_percentage*len(train))]
	...
	# Fit the model		
	model_train.fit(X[train], Y3[train], validation_split=0.1, nb_epoch=200, batch_size=400,  class_weight=class_weight,  shuffle=True, verbose=0, callbacks=callbacks)#sample_weight=sample_weightx[train]
